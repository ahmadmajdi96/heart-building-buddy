  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card-elev rounded-xl border bg-card">
        ...
        view === "month" ? <MonthView cursor={cursor} appts={appts} onSlotClick={openNewAt} onEventClick={openEdit} /> :
        view === "week" ? <WeekView cursor={cursor} appts={appts} onSlotClick={openNewAt} onEventClick={openEdit} /> :
        <DayView cursor={cursor} appts={appts} onSlotClick={openNewAt} onEventClick={openEdit} />}
      </div>
