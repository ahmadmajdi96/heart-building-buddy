      ...
      <div className="container mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:py-32">
        <div className="mb-16 grid items-end gap-10 lg:grid-cols-12">
          <div className="lg:col-span-8">
            ...
            <h2 className="mt-5 font-serif text-3xl leading-[1.02] tracking-[-0.02em] md:text-4xl lg:text-[2.75rem]">
    ...
    <Section id="product" className="bg-background">
      <div className="grid gap-16 lg:grid-cols-12">
        <div className="lg:col-span-5">
          ...
          <h2 className="mt-5 font-serif text-2xl leading-[1.05] tracking-[-0.02em] md:text-3xl">
            {ar(
              locale,
  ...
  return (
    <Section className="bg-pearl/40">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <h2 className="mt-6 font-serif text-3xl leading-[1.02] tracking-[-0.02em] md:text-4xl">
      ...
      <div className="container relative mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:py-32">
        <div className="grid items-start gap-16 lg:grid-cols-12">
          <div className="lg:col-span-5">
            ...
            <h2 className="mt-5 font-serif text-3xl leading-[1.02] tracking-[-0.02em] text-pearl md:text-4xl">
