...
export const cases: Case[] = [
  ...
  { id: "c4", ref: "QD-2026-0076", titleAr: "تحكيم دولي — مشروع البنية التحتية", titleEn: "International arbitration — Infrastructure project", client: "وزارة الأشغال العامة والإسكان", court: "مركز التحكيم الأردني", practice: "تحكيم", status: "active", nextHearing: "2026-07-11", lead: "م. هشام العنزي", progress: 48 },
  { id: "c5", ref: "QD-2025-9842", titleAr: "ميراث وتركة — تقسيم عقاري", titleEn: "Inheritance — Real estate division", client: "ورثة آل سالم", court: "المحكمة الشرعية — عمّان", practice: "أحوال", status: "closed", nextHearing: "—", lead: "أ. منى السبيعي", progress: 100 },
  { id: "c6", ref: "QD-2026-0203", titleAr: "ملكية فكرية — انتهاك علامة تجارية", titleEn: "IP — Trademark infringement", client: "شركة نسيج", court: "محكمة استئناف عمّان", practice: "ملكية فكرية", status: "active", nextHearing: "2026-06-30", lead: "د. ياسر فؤاد", progress: 71 },
  { id: "c7", ref: "QD-2026-0211", titleAr: "اندماج واستحواذ — العناية الواجبة", titleEn: "M&A — Due diligence", client: "شركة الخليج الأردنية للاستثمار", court: "—", practice: "شركات", status: "pending", nextHearing: "2026-07-15", lead: "د. ليلى المنصور", progress: 22 },
];
...
export const documents: Doc[] = [
  ...
  { id: "d6", name: "تقرير العناية الواجبة — شركة الخليج الأردنية", type: "brief", caseRef: "QD-2026-0211", updated: "2026-06-20", size: "1.8 MB", author: "د. ليلى المنصور", status: "draft" },
];
...
export const hearings: Hearing[] = [
  ...
  { id: "h3", date: "2026-06-28", time: "10:00", caseRef: "QD-2026-0203", court: "محكمة استئناف عمّان", type: "نظر دعوى", attendee: "د. ياسر فؤاد" },
...
export const invoices = [
  ...
  { id: "INV-2026-0482", client: "شركة الخليج الأردنية للاستثمار", amount: 12650, currency: "JOD", issued: "2026-06-05", due: "2026-07-05", status: "sent" },
  { id: "INV-2026-0483", client: "وزارة الأشغال العامة والإسكان", amount: 312000, currency: "JOD", issued: "2026-06-10", due: "2026-07-10", status: "overdue" },
